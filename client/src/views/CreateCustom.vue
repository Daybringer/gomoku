  ...
  <BaseView>
    <div
      ...
      <div
        ...
        <div class="flex flex-col place-items-center gap-4">
          <BaseMidHeadline class="my-2">Local/Online</BaseMidHeadline>
          <div class="flex flex-row gap-6">
            <BaseToggleButton @toggle="isLocal = true" :toggled="isLocal">
              <span class="md:text-xl">Local</span>
            </BaseToggleButton>
            <BaseToggleButton @toggle="isLocal = false" :toggled="!isLocal">
              <span class="md:text-xl">Online</span>
            </BaseToggleButton>
          </div>
        </div>
        <div class="flex flex-col place-items-center gap-4">
